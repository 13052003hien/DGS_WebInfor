                    ...
                    <div className="space-y-2">
                        <a
                            ...
                            className={`flex items-center p-3 text-gray-700 hover:bg-blue-50 cursor-pointer rounded-lg ${
                                activeTab === "dashboard" ? "bg-blue-50 text-blue-600 font-medium" : ""
                            }`}
                        >
                        ...
                        <a
                            ...
                            className={`flex items-center p-3 text-gray-700 hover:bg-blue-50 cursor-pointer rounded-lg ${
                                activeTab === "users" ? "bg-blue-50 text-blue-600 font-medium" : ""
                            }`}
                        >
                        ...
                        <a
                            ...
                            className={`flex items-center p-3 text-gray-700 hover:bg-blue-50 cursor-pointer rounded-lg ${
                                activeTab === "projects" ? "bg-blue-50 text-blue-600 font-medium" : ""
                            }`}
                        >
                        ...
                        <a
                            ...
                            className={`flex items-center p-3 text-gray-700 hover:bg-blue-50 cursor-pointer rounded-lg ${
                                activeTab === "locations" ? "bg-blue-50 text-blue-600 font-medium" : ""
                            }`}
                        >
                        ...
                        <a
                            ...
                            className={`flex items-center p-3 text-gray-700 hover:bg-blue-50 cursor-pointer rounded-lg ${
                                activeTab === "contacts" ? "bg-blue-50 text-blue-600 font-medium" : ""
                            }`}
                        >
                        ...
                        <a
                            ...
                            className={`flex items-center p-3 text-gray-700 hover:bg-blue-50 cursor-pointer rounded-lg ${
                                activeTab === "settings" ? "bg-blue-50 text-blue-600 font-medium" : ""
                            }`}
                        >
