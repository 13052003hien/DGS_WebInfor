...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed w-full z-50 transition-all duration-300 ${
            ...
            <div className="container mx-auto px-4">                <div className="flex justify-between items-center h-20">
                    {/* Logo */}
                    ...
                    <div className="hidden lg:flex items-center space-x-8">
                        {navItems.map((item) => (
                            <Link
                                key={item.path}
                                to={item.path}                                className={`text-base font-medium transition-colors duration-200 px-4 py-2 ${
                ...
                {/* Mobile Menu */}
                {isOpen && (
                    <div className="lg:hidden">                        <div className="px-3 pt-3 pb-4 space-y-2">
                            {navItems.map((item) => (
                                <Link
                                    key={item.path}
                                    to={item.path}
