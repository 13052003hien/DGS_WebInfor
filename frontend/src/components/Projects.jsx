...
const Projects = ({ isHomePage }) => {
  ...
  const projectsPerPage = isHomePage ? 6 : 9; // Show fewer projects on homepage
  ...
  // Tính toán dự án cho trang hiện tại
      ...
      <div className="container mx-auto px-4">
        ...
        {currentProjects.length > 0 ? (
              ...
              {currentProjects.map((project, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4 line-clamp-2">{project.projectDetails}</p>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">Không tìm thấy dự án</h3>
            <p className="mt-2 text-gray-500">
              Không có dự án nào phù hợp với tiêu chí tìm kiếm của bạn
            </p>
          </div>
        )}
      </div>
