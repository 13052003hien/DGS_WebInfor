...
const Hero = () => {
  return (
    <div className="bg-gradient-to-b from-blue-900 to-blue-700 text-white min-h-screen relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 h-full">
        <div className="grid md:grid-cols-2 gap-12 items-center min-h-[calc(100vh-5rem)] py-16">
          ...
          >
            ...
            >
              Chúng tôi cung cấp các dịch vụ chuyển số toàn diện trong lĩnh vực
              hành chính công, địa chính, văn bản hành chính với giải pháp hiện
              đại và hiệu quả.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
